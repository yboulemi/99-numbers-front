// generate a placeholder for my private Policy page
...
<template>
    <div>
        ...
        <ul>
            ...
            <li>
                <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to 99numbers.
                </p>
            </li>
            <li>
                <p>
            ...
            <li>
                <p>
                    <strong>Website</strong> refers to 99numbers, accessible
                    from
                    <a
                        href="https://99-numbers.com"
                        rel="external nofollow noopener"
                        target="_blank"
                        >https://99-numbers.com</a
                    >
                </p>
            </li>
            <li>
        ...
        <p>
            We do not use Cookies or similar tracking technologies so far, your session data is kept in local storage and is not shared with any third party.
        </p>
        ...
        <ul>
            <li>By email: support@99-numbers.com</li>
        </ul>
    </div>
</template>
